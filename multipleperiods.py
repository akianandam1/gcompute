...
m_2 = 1
m_3 = 0.75
vec = torch.tensor([-0.9819,  0.0309,  0.0000,  0.9664,  0.0286,  0.0000, -0.0131,  0.0096,
         0.0000,  0.4220,  0.2533,  0.0000,  0.4212,  0.2707,  0.0000, -1.1225,
        -0.6964,  0.0000,  1.0000,  1.0000,  0.7500], requires_grad = True)
