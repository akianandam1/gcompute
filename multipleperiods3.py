...
m_2 = 1
m_3 = 0.75
vec = torch.tensor([-0.981894660877,  0.030794631573,  0.000000000000,  0.966694366295,
         0.028705568899,  0.000000000000, -0.013205146485,  0.009504670980,
         0.000000000000,  0.421894620667,  0.253294667309,  0.000000000000,
         0.421302914924,  0.270693268153,  0.000000000000, -1.122494538439,
        -0.696394544799,  0.000000000000,  1.000000000000,  1.000000000000,
         0.750000000000], dtype=torch.float64, requires_grad = True)

optimizer = torch.optim.NAdam([vec], lr=.000001)
optimize(vec, m_1, m_2, m_3, .0003, 35, 6, 1000, "dopri5", optimizer)
