...
m_2 = 1
m_3 = 0.75
vec = torch.tensor([-0.981892995094,  0.030793172577,  0.000000000000,  0.966685157761,
         0.028709961770,  0.000000000000, -0.013204659016,  0.009501840237,
         0.000000000000,  0.421892587251,  0.253293572662,  0.000000000000,
         0.421296544339,  0.270678896870,  0.000000000000, -1.122491268486,
        -0.696391764438,  0.000000000000], dtype=torch.float64, requires_grad = True)

optimizer = torch.optim.NAdam([vec], lr=.000001)
optimize(vec, m_1, m_2, m_3, .00007, 30, 5, 520, "dopri5", optimizer)
